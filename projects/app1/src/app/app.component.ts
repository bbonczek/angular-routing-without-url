...
@Component({
  ...
  <a class="pure-button" href="/first-page-from-nested-app">First page from nested app</a>
  <a class="pure-button" href="/second-page-from-nested-app">Second page from nested app</a>
