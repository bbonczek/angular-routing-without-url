...
@Component({
  ...
  <a class="pure-button" href="/page-with-nested-app/first-page-from-nested-app">First page from nested app</a>
  <a class="pure-button" href="/page-with-nested-app/second-page-from-nested-app">Second page from nested app</a>
